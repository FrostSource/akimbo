...
local function overrideEnergygun(weapon)
    listenToPistolShoot(weapon)

    ---Manual handling of shooting
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_FIRE, 1, function ()
    ...
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_EJECT_MAGAZINE, 1, function ()
    ...
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_TOGGLE_BURST_FIRE, 1, function ()
    ...
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_SLIDE_RELEASE, 1, function (context, params)
...
local function overrideShotgun(weapon)
    ---Manual handling of shooting
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_FIRE, 1, function ()
        if Time() <= playerReadyShootTime then return end
...
local function overrideRapidfire(weapon)
    ---Manual handling of shooting
    Input:ListenToButton("press", InputHandPrimary, DIGITAL_INPUT_FIRE, 1, function ()
        if Time() <= playerReadyShootTime then return end
...
local function overrideWeapon(weapon)
